...
namespace Shadowsocks.View
{
    ...
    public class DataGridViewProgressCell : DataGridViewImageCell
    {
        ...
        public bool ProgressEnable { get; set; }
            ...
            DataGridViewCellStyle cellStyle, DataGridViewAdvancedBorderStyle advancedBorderStyle, DataGridViewPaintParts paintParts)
        {
            ...
            if (!ProgressEnable)
            {
                ...
                if (this.DataGridView.CurrentRow.Index == rowIndex)
                    g.DrawString((string)value, cellStyle.Font, new SolidBrush(cellStyle.SelectionForeColor), cellBounds.X + 6, cellBounds.Y + 2);
                else
                    g.DrawString((string)value, cellStyle.Font, new SolidBrush(cellStyle.ForeColor), cellBounds.X + 6, cellBounds.Y + 2);
                return;
            }
            else
            {
